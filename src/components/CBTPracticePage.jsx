          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-xl shadow-sm border p-6">
                <div className="mb-6">
                  <h2 className="text-lg font-semibold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4">
                    {question.question}
                  </h2>
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between gap-4 pt-6 border-t">
                  <button
                    ...
                    className="flex items-center justify-center space-x-2 px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm border p-4 sticky top-24">
                <h3 className="font-semibold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4">Questions</h3>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-3 sm:px-6 py-4">
          <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent">CBT Practice Test</h1>
          <p className="text-gray-600">Set up your practice test</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto p-3 sm:p-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          {currentStep === 1 && (
            <div>
              <h2 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4">Select Exam Type</h2>
              <div className="space-y-3">
                {examTypes.map((exam) => (
                  <button
                    key={exam.id}
          ...
          {currentStep === 2 && (
            <div>
              <h2 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4">Select Subject</h2>
              {testConfig.examType ? (
          ...
          {currentStep === 3 && (
            <div>
              <h2 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-6">Test Settings</h2>
          ...
          {currentStep === 4 && (
            <div>
              <h2 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-6">Review & Start</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 capitalize">{testConfig.subject}</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 uppercase">{testConfig.examType}</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">{testConfig.duration} minutes</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">{testConfig.questionCount} questions</div>
                    </div>
                  </div>
                </div>
              </div>
