    ...
    <div className="min-h-screen bg-gray-50 p-3 sm:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-4xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4">Study Buddy Features</h1>
          <p className="text-lg sm:text-xl text-gray-600">Choose how you want to learn today</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-3">Chat</h3>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-3">Upload Notes</h3>
              <p className="text-gray-600 mb-4">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-3">Voice Tutor</h3>
              <p className="text-gray-600 mb-4">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-3">History</h3>
              <p className="text-gray-600 mb-4">
