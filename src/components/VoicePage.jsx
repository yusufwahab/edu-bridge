    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent">Voice Tutor</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-8 mb-8">
          ...
          <h2 className="text-3xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-4">Speak Naturally</h2>
          <p className="text-gray-600 text-lg mb-8">Ask questions and get instant explanations through voice</p>
          <div className="text-center">
          
          <button 
            onClick={() => textToSpeech('Welcome to Voice Tutor. Press the button below to speak and get instant explanations.')}
            className="mb-6 text-blue-600 hover:text-blue-700 flex items-center mx-auto space-x-2"
          >
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          <h3 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-6">Recent Voice Sessions</h3>
              ...
              <div key={session.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">"{session.query}"</h4>
                      <p className="text-gray-600 text-sm">{session.time} • Duration: {session.duration}</p>
                    </div>
                  </div>
