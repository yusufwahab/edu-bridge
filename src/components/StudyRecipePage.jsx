      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent">Study Recipes</h1>
              <p className="text-gray-600 mt-1">AI-powered personalized study plans</p>
            </div>
        ...
        {activeTab === 'my-recipes' && (
          <div className="space-y-6">
            {myRecipes.map((recipe) => (
              <div key={recipe.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <h3 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent">{recipe.title}</h3>
                    <p className="text-gray-600">{recipe.goal}</p>
                    <div className="flex items-center space-x-4 mt-2">
                      <span className="text-sm text-gray-500">Week {recipe.currentWeek} of {recipe.totalWeeks}</span>
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm text-gray-500">{recipe.streak} day streak 🔥</span>
                  </div>
                ...
                {/* Today's Tasks */}
                <div className="mb-6">
                  <h4 className="font-semibold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-3">Today's Tasks</h4>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h5 className="font-medium text-blue-900">This Week's Goal</h5>
                      <p className="text-blue-700 text-sm">{recipe.weeklyGoal}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button className="flex items-center space-x-1 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent mb-2">Create Your Study Recipe</h2>
                <p className="text-gray-600">AI will generate a personalized study plan based on your goal</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-orange-900">AI Recipe Generation</h4>
            ...
            {availableGoals.map((template) => (
              <div key={template.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="font-semibold bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 bg-clip-text text-transparent">{template.label}</h3>
                    <p className="text-gray-600 text-sm">{template.duration} plan</p>
                  </div>
                  <span className={`px-2 py-1 rounded text-xs ${
